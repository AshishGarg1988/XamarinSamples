...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("LocationService.Droid.LocationService.LocationServiceConnection, LocationService.Android", LocationServiceConnection.class, __md_methods);
	}
	...
	public LocationServiceConnection ()
	{
		...
		if (getClass () == LocationServiceConnection.class)
			mono.android.TypeManager.Activate ("LocationService.Droid.LocationService.LocationServiceConnection, LocationService.Android", "", this, new java.lang.Object[] {  });
	}

	public LocationServiceConnection (crc646201cb5e001c7b0e.LocationServiceBinder p0)
	{
		super ();
		if (getClass () == LocationServiceConnection.class)
			mono.android.TypeManager.Activate ("LocationService.Droid.LocationService.LocationServiceConnection, LocationService.Android", "LocationService.Droid.LocationService.LocationServiceBinder, LocationService.Android", this, new java.lang.Object[] { p0 });
	}
